...
('BADGE002', 'ACTIVE', 'DEF456UVW', NOW(), DATE_SUB(NOW(), INTERVAL 45 DAY), DATE_ADD(CURDATE(), INTERVAL 60 DAY), TRUE, DATE_ADD(CURDATE(), INTERVAL 74 DAY)),
('BADGE003', 'ACTIVE', 'GHI789RST', NOW(), DATE_SUB(NOW(), INTERVAL 15 DAY), DATE_ADD(CURDATE(), INTERVAL 180 DAY), FALSE, NULL),
('BADGE004', 'DISABLED', 'JKL012MNO', DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 90 DAY), DATE_SUB(CURDATE(), INTERVAL 30 DAY), FALSE, NULL),
('BADGE005', 'LOST', 'PQR345STU', DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 60 DAY), DATE_ADD(CURDATE(), INTERVAL 120 DAY), TRUE, DATE_SUB(CURDATE(), INTERVAL 134 DAY)),
('BADGE006', 'ACTIVE', 'VWX678YZA', NOW(), DATE_SUB(NOW(), INTERVAL 20 DAY), DATE_ADD(CURDATE(), INTERVAL 30 DAY), FALSE, NULL),
('BADGE007', 'ACTIVE', 'BCD901EFG', NOW(), DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_ADD(CURDATE(), INTERVAL 90 DAY), FALSE, NULL),
('BADGE008', 'ACTIVE', 'HIJ234KLM', NOW(), DATE_SUB(NOW(), INTERVAL 25 DAY), DATE_ADD(CURDATE(), INTERVAL 60 DAY), TRUE, DATE_ADD(CURDATE(), INTERVAL 74 DAY));
